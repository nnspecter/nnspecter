...
- Работа: В активном поиске работы
- Стажировки: itTransition (Fullstack dev) 7aug - oct
...
- Дополнительно: Telegram Api(miniapps)
...
- В процессе разработки: Соревновательная система друзей 
...
- Состояние: неактивный бекенд.(неправильная fsd архитектура ^^ )
